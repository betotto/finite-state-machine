...
;
/* harmony default export */ __webpack_exports__["default"] = (RxjsFsm);
...
/* harmony import */ var ramda_src_keys__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ramda/src/keys */ "./node_modules/ramda/src/keys.js");
/* harmony import */ var ramda_src_keys__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(ramda_src_keys__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var ramda_src_mergeRight__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ramda/src/mergeRight */ "./node_modules/ramda/src/mergeRight.js");
/* harmony import */ var ramda_src_mergeRight__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(ramda_src_mergeRight__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var ramda_src_clone__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ramda/src/clone */ "./node_modules/ramda/src/clone.js");
/* harmony import */ var ramda_src_clone__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(ramda_src_clone__WEBPACK_IMPORTED_MODULE_5__);
...
var selectBack = function selectBack() {
  var otherTabs = ramda_src_keys__WEBPACK_IMPORTED_MODULE_3___default()(tabs).filter(function (t) {
        ...
        switch (evt.event.type) {
          case 'tab-joined':
            ...
            if (tabs[sseTab] === 'active') {
              var backTab = ramda_src_keys__WEBPACK_IMPORTED_MODULE_3___default()(tabs).find(function (t) {
                return tabs[t] === 'back';
              });
          ...
          case 'tab-exists':
            tabs = ramda_src_clone__WEBPACK_IMPORTED_MODULE_5___default()(evt.event.data);
            var isActive = ramda_src_keys__WEBPACK_IMPORTED_MODULE_3___default()(tabs).find(function (t) {
              return tabs[t] === 'active';
            });
          ...
          case 'tab-streaming':
            tabs = ramda_src_mergeRight__WEBPACK_IMPORTED_MODULE_4___default()(tabs, evt.event.data);
            machine.doTransition(sseTransitions.WAIT);
            break;
          ...
          case 'tab-leave':
            if (tabs[evt.sseTab] === 'active') {
              if (tabs[sseTab] === 'back') {
                tabs[sseTab] = 'active';
                var otherTabs = ramda_src_keys__WEBPACK_IMPORTED_MODULE_3___default()(tabs);
          ...
          case 'message':
            console.log('from tab', evt.event.type);
            break;
        }
      }
    }
...
var stop = function stop(isFromTab) {
  ...
  ramda_src_keys__WEBPACK_IMPORTED_MODULE_3___default()(tabs).forEach(function (t) {
    return tabs[t] = 'ready';
  });
};
